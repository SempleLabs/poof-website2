...
One caution on bank rules specifically, since they are the item on that list most likely to backfire: they auto-post, and a rule written slightly too broadly keeps being wrong until somebody notices. There is no dollar ceiling separate from the match and nothing that stops a rule when you correct what it did. Set them tightly, and review what they actually caught once a quarter — not what you meant them to catch. (Poof handles this differently: every AI-proposed change waits for approval with its evidence attached, and a rule you contradict pauses itself. The [comparison page](/poof-vs-quickbooks) lays out the difference.)
...
| Poof | $79 | One plan, all 128 features, no tiers — including job costing and budgets |
...
*Written by Austin Semple, a former controller: three years in audit, seven running the books for small businesses, and the founder of Poof. Poof is one plan at $79/mo with every feature included — [see what's in it](/pricing).*
