...
excerpt: "A working chart of accounts for an HVAC shop — every income, COGS, expense, and asset account, why each one exists, and the setup mistakes that make a P&L useless for pricing."
category: "Trades"
