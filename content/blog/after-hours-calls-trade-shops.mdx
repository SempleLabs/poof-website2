...
- **It is not self-serve.** We provision the number and the voice agent as part of Poof for shops. There is no button in the app for a shop owner to switch it on.
...
*Written by Austin Semple, a former controller: three years in audit, seven running the books for small businesses, and the founder of Poof. The AI receptionist is installed as part of [Poof for shops](/trades) — our team sets it up; it is not a switch you flip yourself.*
