...
**Customer deposits are a liability, not revenue.** Money taken up front on a generator install before any work is done is not yours yet. In Poof Managed for Trades that is the default: the deposit sits as a liability and is released to the job's revenue when the install is completed.
