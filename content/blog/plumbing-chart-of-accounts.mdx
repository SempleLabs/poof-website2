...
**Customer deposits are a liability, not revenue.** Money taken up front on a repipe before any work is done is not yours yet. It belongs in a liability account until you have performed. In Poof for shops that is the default: the deposit sits as a liability and is released to the job's revenue when the job is completed.
