...
- **$750K–$3M (2–6 trucks):** This is where ticket volume outruns owner-run books and where per-job margin starts being worth real money. A managed service with job costing built in costs about what a good part-time bookkeeper does, and delivers what they structurally can't — [see how Poof Managed Bookkeeping works](/trades).
