...
| Managed service built for trades | ~$1,200/mo | Books closed by the 15th business day, per-job P&L on every close, every job costed within 5 business days, field-service data imported for you, a controller reviewing the work — [pricing and details here](/plumbing) |
...
- **$750K–$3M (2–6 trucks):** This is where ticket volume outruns owner-run books and where per-job margin starts being worth real money. A Poof for shops with job costing built in costs about what a good part-time bookkeeper does, and delivers what they structurally can't — [see how Poof for shops works](/trades).
...
*Written by Austin Semple, a former controller: three years in audit, seven running the books for small businesses, and the founder of Poof. If you'd rather have this whole system run for you — per-job P&L with every monthly close, reviewed by a controller you can text — [that's what Poof for shops is](/plumbing).*
