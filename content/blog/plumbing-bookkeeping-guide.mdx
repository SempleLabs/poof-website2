...
- **$750K–$3M (2–6 trucks):** This is where ticket volume outruns owner-run books and where per-job margin starts being worth real money. A managed service with job costing built in costs about what a good part-time bookkeeper does, and delivers what they structurally can't — [see how The Augmented Operator works](/trades).
...
*Written by Austin Semple, a former controller with 10+ years of audit and controller experience, and the founder of Poof. If you'd rather have this whole system run for you — per-job P&L with every monthly close, reviewed by a controller you can text — [that's what The Augmented Operator is](/plumbing).*
