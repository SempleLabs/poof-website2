...
*Written by Austin Semple, a former controller with ten years as an auditor and controller, and the founder of Poof. If you'd rather have this whole system run for you — per-job P&L with every monthly close, reviewed by a controller you can text — [that's what Poof Managed Bookkeeping is](/plumbing).*
