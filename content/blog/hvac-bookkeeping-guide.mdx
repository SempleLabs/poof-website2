...
| Poof | $79/mo | Per-job P&L on every close, a chart of accounts built for the trade, field-service data imported for you, and every AI entry staged for a person to approve — [see Poof for shops](/trades) |
...
## DIY, a bookkeeper, or software built for the work?
...
- **$750K–$3M (2–6 trucks):** This is where per-job profitability starts being worth real money and where owner-run books stop keeping up. Software with job costing built in costs a fraction of a part-time bookkeeper and delivers what they structurally can't: [see how Poof for shops works](/trades).
...
*Written by Austin Semple, a former controller: three years in audit, seven running the books for small businesses, and the founder of Poof. Poof runs this for $79 a month — per-job P&L on every close, with every AI entry staged for you to approve: [that's what Poof for shops is](/trades).*
