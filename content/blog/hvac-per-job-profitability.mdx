...
**The harder problem: hours that don't belong to one job.** Time-on-job handles the clean case — a tech is at the Henderson install from 8am to 3pm. What it does not handle is the rest of the payroll. Shop time, a morning spent pulling permits, a tech riding along on a job that only needed one person, drive time between three calls. Those hours are real, they are paid, and they belong to the work somewhere.

Most shops handle this by ignoring it, which means their job costs only include the hours that happened to be tagged. Your jobs then look profitable while your P&L says otherwise, and nobody can explain the gap. If your costed labor for the month is materially less than your actual payroll, that gap is the answer.

Two workable approaches:

- **Allocate the untagged hours proportionally.** Total your paid direct-labor hours for the month, subtract the hours already tagged to jobs, and spread the remainder across jobs in proportion to their tagged hours. Crude, but it closes the gap and it is defensible.
- **Allocate by job type.** If installs reliably carry more untagged overhead than service calls — permits, staging, a second body for a lift — weight the allocation accordingly rather than spreading it evenly.

Either way, the test is the same: **the labor cost you assigned to jobs this month should reconcile to the direct labor on your P&L.** If it does not, your per-job margins are systematically overstated by the difference. This is the single most common reason a shop's job costing says 34% while the income statement says 26%.
...
**Pattern 3: Managed bookkeeping with direct field-service integration.** A service like [Poof Managed Bookkeeping](/hvac) connects directly to Jobber or Housecall Pro, pulls job data into the ledger automatically, and produces per-job P&Ls without manual rekeying. A former controller reviews the categorizations before anything is final, so the numbers are audit-grade. This is what we built for shops that hit the ceiling on patterns 1 and 2.
...
### Compare jobs against each other, not just against a target

A single job's margin is hard to judge in isolation. Is 27% good on a heat pump changeout? It depends on the equipment, the crew, the season, and what your other changeouts returned.

The more useful comparison is against your own similar jobs. Group by job type and look at the spread rather than the average. A changeout that ran 12 points under your other changeouts is a specific, answerable question — was it the equipment cost, the hours, a callback, a discount someone gave in the truck? An average tells you none of that, and the outliers are where the money is.

Two habits make this work. Review by job type every month rather than looking at the whole list. And look at the bottom of each group specifically, because a couple of bad jobs inside an acceptable average is the most common way a real pricing problem stays hidden.

### Watch for costs that never made it onto the job

Some costs are real, attributable, and almost never costed to the work that caused them:

- **Callback labor.** A return trip on a job already invoiced. If it lands in a general labor bucket, the original job keeps a margin it never earned.
- **Permits and inspections**, including re-inspection trips.
- **Financing dealer fees.** When a customer finances an install, the lender funds you less a fee that comes out of your side. Recorded in general expenses, financed jobs report a margin they never earned — often by 6 to 10 points. This is covered in [why dealer financing hides your real install margin](/blog/dealer-financing-job-margin).

The rule underneath all three: if a cost was caused by a specific job, it belongs on that job.
...
For the broader picture — the chart of accounts, the Jobber-to-books handoff, the monthly close routine, and what each bookkeeping option costs — see our [complete guide to HVAC bookkeeping](/blog/hvac-bookkeeping-guide). Running plumbing or electrical work too? The [plumbing bookkeeping guide](/blog/plumbing-bookkeeping-guide) and [electrical contractor bookkeeping guide](/blog/electrical-contractor-bookkeeping-guide) cover what those trades need.

And if you'd rather have all of this done for you, [Poof Managed Bookkeeping](/hvac) is built for exactly this: per-job P&L with every monthly close, built from your existing Jobber or Housecall Pro data, reviewed by a former controller — no rekeying by you.
