...
faqs:
  - question: "Why is QuickBooks so expensive?"
    answer: "Two things drive it: tiered pricing that pushes you upward as you need ordinary features, and add-ons billed separately. Simple Start runs $38/mo, Essentials $75/mo, and Plus $115/mo — and job costing and project tracking only appear on Plus. Payroll is another $50 to $130 on top, and extra users cost more again. Most owners do not start on the expensive tier; they get moved there by one feature they needed."
  - question: "What is the cheapest alternative to QuickBooks?"
    answer: "Wave is the cheapest at free, but it is limited and support is thin. Xero's Growing plan is $55/mo with unlimited users. Poof is $79/mo flat for all 78 features with no tiers and no add-ons, which matters most if QuickBooks moved you to the $115/mo Plus tier for job costing or budgets. The honest comparison is not sticker price — it is the total once you add the tiers and add-ons you actually need."
  - question: "Can I downgrade my QuickBooks plan to save money?"
    answer: "Often yes, and it is the least disruptive option. Going from Plus to Simple Start saves $77/mo, over $900 a year. The test is whether you have genuinely used each premium feature in the past 90 days — QuickBooks does not surface that clearly, so you have to check feature by feature. The catch is that downgrading can be disruptive: some features and data are unavailable on lower plans, so review what you would lose first."
  - question: "How much should small business bookkeeping cost per month?"
    answer: "If you are paying for both software and a bookkeeper, the combination commonly runs $400 to $600 a month. Software alone should be $38 to $115 depending on tier. Moving from a $400/mo bookkeeper to AI bookkeeping at $79/mo saves $321/mo — and even keeping a bookkeeper for quarterly reviews at $100 a quarter, annual cost drops from $4,800 to $1,348, a 72% reduction."
...
- **Essentials:** $75/mo (3 users, bill management, time tracking)
- **Plus:** $115/mo (5 users, inventory, project tracking)

And that is before add-ons like payroll ($50-$130/mo extra), advanced payments processing, or additional users.

For a small business doing under $500K in revenue, spending $75 to $115 per month on accounting software is a real expense. If that cost is bothering you, here are five things you can do about it — ranked from least disruptive to most.
...
**Savings:** Downgrading from Plus to Simple Start saves $77/mo — over $900 per year.
...
- $79/mo flat for all 78 features — no tiers, no add-ons
...
**Example:** If you are paying $75/mo for QuickBooks Essentials, $15/mo for a separate invoicing tool, and $10/mo for a receipt scanning app, that is $100/mo across three systems that don't talk to each other. A single platform that includes all three at $79/mo costs less — and the bigger win is eliminating the hours spent syncing data between systems. And if you're on the $115/mo Plus tier for job costing or budgets, the savings are $36/mo before you count the add-on tools.
