...
Go to [poofai.com/spend-score](/spend-score) and upload your bank statement. The tool accepts three formats:
...
Privacy is built into the tool by design. Your bank statement is sent to our AI provider (OpenAI) to generate your report and is not retained by Poof afterward or used to train AI models. We never store the statement itself or your individual transactions. If you choose to enter your email, we save it — along with a couple of summary stats like your transaction count — so we can send you a copy of the report.

## Get Your Free Spend Score

Your Spend Score is free, takes under 60 seconds, and requires no account or credit card. Upload your bank statement at [poofai.com/spend-score](/spend-score) and see where you stand.

If you like what you see, Poof does this automatically for every transaction, every day — plus invoicing, reconciliation, budgeting, forecasting, and 13 financial reports. Start your free trial at [poofai.com](https://www.poofai.com).
