...
Privacy is built into the tool by design. Your bank statement is sent to our AI provider (OpenAI) to generate your report and is not retained by Poof afterward or used to train AI models. The only thing we save is your email address (if you choose to enter one) so we can send you a copy of the report.
