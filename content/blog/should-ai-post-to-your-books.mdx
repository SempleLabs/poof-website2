...
faqs:
  ...
  - question: "Should AI ever send an invoice or email to a customer on its own?"
    answer: "No. Anything that reaches a customer is a person's decision, whatever a rule says. Ledger writes can be automated inside limits; customer-facing sends should not be."
---
