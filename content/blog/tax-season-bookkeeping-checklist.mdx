...
faqs:
  - question: "What is a bookkeeping cleanup?"
    answer: "A bookkeeping cleanup (also called catch-up bookkeeping) is a one-time effort to bring neglected or inaccurate financial records up to date: reconciling every account to its statements, categorizing every transaction, separating personal from business spending, recording missing income, and producing accurate year-end reports. It fixes the backlog; ongoing monthly bookkeeping keeps it from happening again."
  - question: "How long does a bookkeeping cleanup take?"
    answer: "If your statements and receipts are available and it's a single year, a focused cleanup realistically takes a weekend. A full year of neglected books with missing receipts and mixed personal/business spending typically takes one to two weeks of part-time work. Multiple years behind can run several weeks — the point at which most owners hand it to a professional or use AI tools to compress the work."
  - question: "How much does a bookkeeping cleanup cost?"
    answer: "DIY costs only your software subscription (often $15–$30/month) and your time. Hiring a bookkeeper or cleanup service is typically priced per month of books you're behind — commonly $200–$500 per month behind, so a full year often lands between $500 and $5,000+ depending on volume and messiness. AI bookkeeping tools handle it for a flat monthly subscription."
  - question: "Can I clean up my own books without a bookkeeper?"
    answer: "Yes — most single-year cleanups are within reach for an owner who follows a checklist, especially if records are intact. DIY if it's one year with statements available; hire it out if you're multiple years behind or face inventory, payroll, and depreciation complexity; use AI either way to automate the slowest steps, reconciliation and categorization."
  - question: "When should you do a bookkeeping cleanup?"
    answer: "Before tax season (the most common trigger — clean books mean fewer billable CPA hours and less amended-return risk), before a loan application, investment, or sale, and whenever your reports stop making sense — negative cash balances, revenue that looks wrong, or a P&L you don't believe."
---
