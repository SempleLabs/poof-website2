      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimateOnScroll animation="fade-up" delay={200}>
          <div className="overflow-x-auto">
            <table className="w-full bg-midnight-700 rounded-2xl overflow-hidden border border-midnight-600">
              <thead>
                <tr className="border-b-2 border-midnight-600">
                  <th className="text-left px-6 py-5 text-sm font-semibold text-slate-400 w-1/3">
                    Feature
                  </th>
                  <th className="px-4 py-5 text-center bg-gold-500/10">
                    ...
                    <div className="mt-1 inline-block bg-gold-500 text-midnight-900 text-xs font-bold px-2 py-0.5 rounded">RECOMMENDED</div>
                  </th>
                  <th className="px-4 py-5 text-center">
                    <div className="text-sm font-semibold text-slate-400">QuickBooks</div>
                    <div className="text-xs text-slate-500">$38/mo+</div>
                  </th>
                  <th className="px-4 py-5 text-center">
                    <div className="text-sm font-semibold text-slate-400">Xero</div>
                    <div className="text-xs text-slate-500">$15/mo+</div>
                  </th>
                  <th className="px-4 py-5 text-center">
                    <div className="text-sm font-semibold text-slate-400">FreshBooks</div>
              ...
              <tbody>
                {features.map((feature, index) => (
                  <tr key={index} className={`border-b border-midnight-600 table-row-hover ${index % 2 === 0 ? 'bg-midnight-700/50' : ''}`}>
