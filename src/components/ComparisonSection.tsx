...
const features = [
  ...
  { name: 'Report Drill-Down (Click to See Journal Entries)', poof: true, quickbooks: false, xero: false, freshbooks: false },
  { name: 'Scheduled Report Delivery (Email, PDF/CSV)', poof: true, quickbooks: false, xero: false, freshbooks: false },
  { name: 'Bank Statement PDF Import via AI Chat', poof: true, quickbooks: false, xero: false, freshbooks: false },
  ...
  { name: 'Estimates & Quotes', poof: true, quickbooks: false, xero: true, freshbooks: true },
  { name: 'AI Depreciation & Recurring Entry Setup', poof: true, quickbooks: false, xero: false, freshbooks: false },
  { name: 'Personalized Dashboard with AI Daily Briefing', poof: true, quickbooks: false, xero: false, freshbooks: false },
  ...
  { name: 'Audit Logs with PII Masking', poof: true, quickbooks: false, xero: false, freshbooks: false },
