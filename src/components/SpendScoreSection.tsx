      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-ledger-100 border border-ledger-300 rounded-2xl px-6 py-10 sm:px-12 sm:py-12">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-slate-900 mb-3">
            What&apos;s your <span className="text-ledger-600">Spend Score</span>?
          </h2>
          ...
          <Link
            href="/spend-score"
            className="inline-block bg-ledger-500 text-white font-semibold px-8 py-3.5 rounded-lg text-base hover:bg-ledger-500 shadow-md transition-all duration-200 hover:-translate-y-0.5"
          >
            Get My Score
          </Link>
