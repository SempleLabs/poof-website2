          ...
          <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-2xl p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-2.5 rounded-lg bg-white border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-ledger-500/20 focus:border-ledger-500 transition-colors"
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    id="website"
                    name="website"
                    className="flex-1 px-4 py-2.5 rounded-r-lg bg-white border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-ledger-500/20 focus:border-ledger-500 transition-colors"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  name="revenue_range"
                  required
                  className="w-full px-4 py-2.5 rounded-lg bg-white border border-slate-300 text-slate-900 focus:outline-none focus:ring-1 focus:ring-ledger-500/20 focus:border-ledger-500 transition-colors"
                >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium border transition-all duration-200 ${
                      selectedPlatforms.includes(platform)
                        ? 'bg-ledger-500 text-white border-ledger-500'
                        : 'bg-white text-slate-600 border-slate-300 hover:border-ledger-300'
                    }`}
                  >
                    {platform}
                  </button>
            ...
            <div>
              ...
              <textarea
                ...
                name="pain_point"
                rows={3}
                className="w-full px-4 py-2.5 rounded-lg bg-white border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-ledger-500/20 focus:border-ledger-500 transition-colors resize-none"
            ...
            <button
              ...
              className="w-full bg-ledger-500 text-white font-semibold px-8 py-4 rounded-lg text-lg hover:bg-ledger-600 transition-all duration-200 hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
            >
