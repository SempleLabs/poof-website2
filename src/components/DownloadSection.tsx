      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl font-bold text-slate-800 mb-4">Free Downloads</h2>
            <p className="text-slate-600">Practical templates and guides to improve your bookkeeping</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {guides.map((guide, index) => (
              <div key={index} className="bg-white border border-slate-200 rounded-xl p-6 text-center">
                ...
                <h3 className="font-bold text-slate-800 mb-2">{guide.title}</h3>
                ...
                <button
                  ...
                  className="w-full bg-ledger-500 text-white font-semibold py-2 px-4 rounded-lg hover:bg-ledger-400 transition-colors text-sm"
                >
                  Download Free
                </button>
              </div>
