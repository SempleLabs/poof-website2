export function getOrganizationSchema() {
  return {
    ...
    description: 'Managed bookkeeping for HVAC, plumbing, and electrical contractors — AI agents do the books, a former controller reviews every monthly close. Also available as self-serve AI bookkeeping software: 108 features, 13 reports, $79/mo.',
    sameAs: [
...
export function getSoftwareApplicationSchema() {
  return {
    ...
    operatingSystem: 'Web',
    description: 'Bookkeeping that does itself. AI categorizes your transactions, reconciles your accounts, and closes your books — so you never touch a spreadsheet again. 108 features including job costing, month-end close, budgeting, forecasting, invoicing, estimates, and 13 financial reports.',
    url: 'https://www.poofai.com',
    offers: {
      '@type': 'Offer',
      price: '79',
