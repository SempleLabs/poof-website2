...
const highlights = [
  ...
  },
  {
    ...
    body: 'Tag transactions, bills, and invoices to jobs and see margin per job — the feature QuickBooks reserves for its $115/mo Plus tier.',
  },
  {
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <AnimateOnScroll animation="fade-up" delay={100}>
            <p className="text-lg sm:text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              Connect your accounts and Poof categorizes, reconciles, and closes your books — 78 features, one plan, built by a former controller. Normally $79/mo with a 30-day trial.
            </p>
          </AnimateOnScroll>
