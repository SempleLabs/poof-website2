...
export const metadata: Metadata = {
  ...
  description: '$29/mo for everything QuickBooks charges $38+ for — 78 features, 13 reports, AI budgeting & forecasting. 30-day free trial, then $14.50/mo launch price.',
  ...
  openGraph: {
    ...
    description:
      '$29/mo for everything QuickBooks charges $38+ for. One plan, 78 features, 13 reports, AI budgeting & forecasting. 30-day free trial.',
