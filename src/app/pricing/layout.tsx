...
export const metadata: Metadata = {
  ...
  description: '$29/mo for everything QuickBooks charges $38+ for. One plan, 69 features, 13 reports, AI budgeting & forecasting. 30-day free trial, then $14.50/month (50% off launch special). No tiers, no hidden fees.',
