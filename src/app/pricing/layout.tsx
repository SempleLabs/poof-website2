...
export const metadata: Metadata = {
  ...
  description: 'One price, every feature — $79/mo flat vs $140/mo for QuickBooks Plus. 93 features, 13 reports, AI budgeting & forecasting. 30-day free trial, then $39.50/mo launch price.',
  ...
  openGraph: {
    ...
    description:
      'One price, every feature — $79/mo flat vs $140/mo for QuickBooks Plus. One plan, 93 features, 13 reports, AI budgeting & forecasting. 30-day free trial.',
