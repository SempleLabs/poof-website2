...
const config = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { number: '4', title: 'Never do this again', description: 'Set up Poof for $79/mo and your books stay clean automatically. Next tax season, your accountant gets a clean handoff.' },
    ],
  },
  socialProof: {
  ...
  faqs: [
    ...
    { question: 'How much does Poof cost after the analysis, and is there a trial?', answer: 'Poof is $79/month flat for all 105 features — no tiers, no add-ons — with a launch special of $39.50/month for your first 3 months. There\'s a 30-day free trial with no credit card required, so you can keep your books clean automatically and never fall this far behind again.' },
  ],
