...
const config = {
  ...
  faqs: [
    ...
    { question: 'Is this a tax or audit service, and am I required to buy Poof afterward?', answer: 'No. This is an operational financial analysis, not a CPA audit, attestation, tax, or assurance service, and we do not file taxes. You are never obligated to purchase anything, though if you\'d like ongoing AI bookkeeping, Poof is a flat $79/mo with all 108 features and a 30-day free trial that requires no credit card.' },
  ],
