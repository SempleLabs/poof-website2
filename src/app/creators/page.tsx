...
const config = {
  ...
  faqs: [
    ...
    { question: 'What is the free analysis, and what does Poof cost after?', answer: 'The free creator finance analysis is an operational review — you apply, spots are limited, and you get your results in about 5-7 days; it is not a CPA audit or tax filing. If you continue with the software, Poof is $79/mo flat (currently $39.50/mo for your first 3 months) with all 93 features and 13 reports included, no tiers or add-ons, plus a 30-day free trial with no credit card.' },
  ],
