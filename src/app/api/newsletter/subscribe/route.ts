                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <p style="margin: 0 0 30px; color: #334155; font-size: 16px; line-height: 1.6;">
                        Poof handles categorization, reconciliation, invoicing, budgeting, and reporting automatically — so you spend minutes on your books instead of hours. 110 features, one flat price.
                      </p>
