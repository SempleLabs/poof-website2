...
export const metadata: Metadata = {
  ...
  description:
    'A managed bookkeeping service for electrical contractor shops doing $750K–$3M. Per-job profitability in 48 hours. Monthly close in 24 hours. Works with your existing Jobber or Housecall Pro.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'Per-job profitability in 48 hours. Monthly close in 24 hours. AI-powered, controller-reviewed bookkeeping for electrical service shops.',
...
const howItWorks = [
  ...
  },
  {
    ...
    body: 'Transactions land in your ledger, mapped to a chart of accounts built for electrical service work. Receipts from supply-house runs are scanned and matched to jobs.',
  },
  {
    number: '3',
  ...
  },
  {
    ...
    body: 'Ask "did the Main Street panel upgrade make money?" in your dedicated Slack channel. Get an answer back the same day — not three weeks later.',
  },
]
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimateOnScroll animation="fade-up">
            ...
            >
              Bookkeeping for electrical shops. <span className="text-gradient-gold">Per-job profitability in 48 hours.</span> Monthly close in 24.
            </h1>
          </AnimateOnScroll>
            ...
            <div className="mt-16 max-w-3xl mx-auto">
              <div className="rounded-2xl bg-white border border-slate-200 shadow-xl overflow-hidden text-left">
                <div className="px-6 py-3 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
                  <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Per-job P&amp;L · Main Street panel upgrade · completed Wed</div>
                  <div className="text-xs text-violet-600 font-semibold">Delivered to Slack · 44 hrs</div>
                </div>
