...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Poof for shops — Bookkeeping for Electrical Contractors',
    description:
...
const extras = [
  {
    ...
    price: '$1,500',
    body: 'Historical cleanup up to 18 months, QBO or Xero migration, Jobber / Housecall Pro setup, chart of accounts aligned to electrical service work. Your $750 audit credits against this in full if you sign within 30 days.',
  },
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            getServiceSchema({
              name: 'Poof for shops — Electrical Contractor Bookkeeping',
              description:
                'Bookkeeping for electrical contractors doing $750K–$3M. Per-job profit on every monthly close, AI-powered and reviewed by a former controller. From $1,200/mo.',
              price: '1200',
              url: 'https://www.poofai.com/electrical',
            })
          ),
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            getBreadcrumbSchema([
              ...
              { name: 'Electrical', url: 'https://www.poofai.com/electrical' },
            ])
          ),
        }}
      />
