...
const config = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { number: '4', title: 'Decide on next steps', description: 'Implement the fixes yourself or let Poof automate your bookkeeping for $79/mo.' },
    ],
  },
  socialProof: {
