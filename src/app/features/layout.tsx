...
export const metadata: Metadata = {
  ...
  description: '68 features, one flat price — $29/mo. AI categorization, budgeting, cash flow forecasting, recurring invoices, receipt scanning, auto-reconciliation, 13 reports, and more. Everything QuickBooks charges $38+ for.',
