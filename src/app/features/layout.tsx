...
export const metadata: Metadata = {
  ...
  description: '78 features, one flat price — $29/mo. AI categorization, budgeting, cash flow forecasting, invoicing, receipt scanning, auto-reconciliation, and 13 reports.',
  ...
  openGraph: {
    title: 'Poof Features — 78 Tools, One Flat Price',
    description:
      '78 features for $29/mo: AI categorization, budgeting, cash flow forecasting, invoicing, receipt scanning, auto-reconciliation, and 13 reports.',
