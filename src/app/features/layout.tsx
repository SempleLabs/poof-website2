...
export const metadata: Metadata = {
  ...
  description: '78 features, one flat price — $79/mo. AI categorization, budgeting, cash flow forecasting, invoicing, receipt scanning, auto-reconciliation, and 13 reports.',
  ...
  openGraph: {
    ...
    description:
      '78 features for $79/mo: AI categorization, budgeting, cash flow forecasting, invoicing, receipt scanning, auto-reconciliation, and 13 reports.',
