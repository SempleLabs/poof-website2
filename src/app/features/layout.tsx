...
export const metadata: Metadata = {
  ...
  description: '128 features, one flat price — $79/mo. AI categorization, budgeting, cash flow forecasting, invoicing, job costing, receipt scanning, auto-reconciliation, and 13 reports.',
