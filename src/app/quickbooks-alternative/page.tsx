...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'QuickBooks Alternative for Small Business | Poof',
    description: 'Same power, one flat price, none of the complexity. See why small businesses are switching from QuickBooks to Poof.',
...
const config = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { number: '4', title: 'Decide on next steps', description: 'Switch to Poof at $79/mo or use the insights to optimize your current setup.' },
    ],
  },
  socialProof: {
  ...
  faqs: [
    ...
    { question: 'What does Poof include that QuickBooks Online charges extra for or locks behind a higher plan?', answer: 'Poof is one flat plan at $79/mo with all 108 features and 13 reports included, no tiers or add-ons. With QuickBooks Online, deeper reporting and capabilities typically mean upgrading from Simple Start ($38/mo) to Essentials ($85/mo) or Plus ($140/mo) — Intuit raised those prices on August 1, 2026. Note that neither Poof nor QuickBooks files your taxes, and Poof does not run payroll.' },
    ...
    { question: 'What does Poof itself cost, and is there a trial?', answer: 'Poof is $79/mo flat for everything, with a 30-day free trial and no credit card required to start. There is also a launch special of $39.50/mo for your first three months. Your bank connections run read-only through Plaid, which supports over 12,000 banks.' },
  ],
