...
const config = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { number: '4', title: 'Decide on next steps', description: 'Implement the fixes yourself or let Poof automate your bookkeeping and give you a real-time profit dashboard for $79/mo.' },
    ],
  },
  socialProof: {
  ...
  faqs: [
    ...
    { question: 'What does Poof itself cost if I want ongoing ecommerce bookkeeping?', answer: 'Poof is AI bookkeeping software at a flat $79/mo with all 110 features included — no tiers and no add-ons — plus a launch special of $39.50/mo for your first 3 months. You can start with a 30-day free trial that requires no credit card. Poof does not run payroll or file your taxes.' },
  ],
