...
const config = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      { number: '4', title: 'Decide on next steps', description: 'Keep the spreadsheet with better practices, or let Poof automate everything for $79/mo. Your choice.' },
    ],
  },
  socialProof: {
