...
export const metadata: Metadata = {
  ...
  description:
    'A managed bookkeeping service for HVAC shops doing $750K–$3M. Per-job profitability in 48 hours. Monthly close in 24 hours. Built on your existing Jobber or Housecall Pro data.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'Per-job profitability in 48 hours. Monthly close in 24 hours. AI-powered, controller-reviewed bookkeeping for service contractor shops.',
...
const howItWorks = [
  ...
  },
  {
    ...
    body: 'Transactions land in your ledger, mapped to a chart of accounts built for your trade. Receipts from supply-house runs are scanned and matched to jobs.',
  },
  {
    number: '3',
  ...
  },
  {
    ...
    body: 'Ask "did the Henderson install make money?" in your dedicated Slack channel. Get an answer back the same day — not three weeks later.',
  },
]
...
const replaces = {
  ...
  poof: [
    ...
    'Managed-service tier at $999/mo — and you get controller review on every decision',
    'Monthly close in 24 hours. Per-job P&L within 48 hours of the truck leaving',
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimateOnScroll animation="fade-up">
            ...
            >
              The bookkeeping service for HVAC shops. <span className="text-gradient-gold">Per-job profitability in 48 hours.</span> Monthly close in 24.
            </h1>
          </AnimateOnScroll>
            ...
            <div className="mt-16 max-w-3xl mx-auto">
              <div className="rounded-2xl bg-white border border-slate-200 shadow-xl overflow-hidden text-left">
                <div className="px-6 py-3 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
                  <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Per-job P&amp;L · Henderson install · completed Tue</div>
                  <div className="text-xs text-violet-600 font-semibold">Delivered to Slack · 41 hrs</div>
                </div>
