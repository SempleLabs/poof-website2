      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimateOnScroll animation="fade-up">
            ...
            >
              HVAC bookkeeping, done for you. <span className="text-ledger-600">Finally know which jobs actually made money.</span>
            </h1>
          </AnimateOnScroll>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimateOnScroll animation="fade-up">
            <p className="text-center text-slate-600">
              ...
              <Link href="/blog/hvac-bookkeeping-guide" className="text-ledger-700 font-semibold hover:underline">
