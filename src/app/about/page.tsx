...
export default function AboutPage() {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: "Today, Poof includes 60 features — AI budgeting & forecasting, recurring invoices with automated follow-ups, estimates, receipt scanning, recurring charge detection, bank statement import, AI-powered account management and depreciation setup, personalized dashboard, 13 financial reports, and more. We're combining deep industry expertise with cutting-edge AI to make bookkeeping truly effortless."
    }
  ]
