...
export default function AboutPage() {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: "Today, Poof includes 68 features — AI budgeting & forecasting, recurring invoices with automated follow-ups, estimates, receipt scanning, recurring charge detection, bank statement import (CSV/PDF including AI-powered PDF parsing via chat), AI-powered account management and depreciation setup, personalized dashboard with AI daily briefing, report drill-down, scheduled report delivery, 13 reports, and more. We're combining deep industry expertise with cutting-edge AI to make bookkeeping truly effortless."
    }
  ]
