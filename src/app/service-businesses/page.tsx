...
const config = {
  ...
  faqs: [
    ...
    { question: 'How much is Poof, and is there a free trial?', answer: 'Poof is a flat $79 a month with all 105 features included, no tiers or add-ons, plus a launch special of $39.50 a month for your first 3 months. You can start with a 30-day free trial and no credit card required.' },
  ],
